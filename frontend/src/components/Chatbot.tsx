...
const getBotAnswer = (message: string) => {
  ...
  if (
    ...
    return "La connexion client et l'inscription sont separées : utilisez Connexion pour un compte existant, ou Inscription pour creer un nouveau compte. Une fois connecte, votre nom, votre photo et votre historique apparaissent dans votre espace client.";
  }
